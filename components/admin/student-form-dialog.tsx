        ...
        <form key={student?.id ?? "new"} onSubmit={handleSubmit} className="flex flex-col gap-[22px]">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {!student && (
                <div className="flex flex-col gap-[7px]">
                  <Label htmlFor="student-rate" className="text-xs font-semibold">
            ...
            <p className="text-xs leading-[18px] text-muted-foreground">
              {student
                ? "Teacher, rate and weekly days are edited from the student panel — this dialog covers the details."
                : "Rates are per student — two students can pay different amounts for the same duration. Assign a teacher and weekly days from the student panel after adding."}
            </p>
          </div>
